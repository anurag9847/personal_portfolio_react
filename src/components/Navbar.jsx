            ...
            <nav className='fixed left-0 right-0 top-4 z-50'>
                ...
                <div className='mx-auto hidden max-w-2xl items-center justify-center rounded-lg bg-black/20 py-3 backdrop-blur-lg lg:flex'>
                    <div className='flex justify-between gap-6'>
                        <div>
                            <a href="#">
                                <img src={logo} width={90} className='lg:h-[24px]' alt="logo" />
                            </a>
                        </div>
                        <div>
                ...
                {/*Mobile Menu*/}
                <div className='rounded-lg lg:hidden backdrop-blur-md'>
                    ...
                    {isMobileMenuOpen && (
                        <ul className='ml-2 mt-4 flex flex-col gap-4  backdrop-blur-md'>
                            {NAVIGATION_LINKS.map((item, index) => (
                                <li key={index}>
                                    <a href={item.href} className='block w-full text-xl font-semibold'
